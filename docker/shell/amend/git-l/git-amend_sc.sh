...
curl -X POST host.docker.internal:3000/api/scoring/amend -H "Content-Type: application/json" -d "{${id}, ${amend}}"
curl -X POST host.docker.internal:3000/api/scoring/no_edit -H "Content-Type: application/json" -d "{${id}, ${no_edit}}"
