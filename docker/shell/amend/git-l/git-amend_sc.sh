...
curl -X POST 192.168.163.225/api/scoring/amend -H "Content-Type: application/json" -d "{${id}, ${amend}}"
curl -X POST 192.168.163.225/api/scoring/no_edit -H "Content-Type: application/json" -d "{${id}, ${no_edit}}"
