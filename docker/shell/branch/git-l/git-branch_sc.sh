...
curl -X POST 192.168.163.225/tutorial/api/scoring/branch -H "Content-Type: application/json" -d "{${id}, ${branch}}"
curl -X POST 192.168.163.225/tutorial/api/scoring/merge -H "Content-Type: application/json" -d "{${id}, ${merge}}"
